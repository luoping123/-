<template>
  <view class="goods-item">
    ...
    <view class="goods-item-left">
      ...
      <image @click="gotoDetailClickHandler" :src="goods.goods_small_logo || defaultPic" class="goods-pic"></image>
    </view>
    <!-- 商品右侧信息区域 -->
    <view class="goods-item-right">
      <!-- 商品标题 -->
      <view class="goods-name" @click="gotoDetailClickHandler">{{goods.goods_name}}</view>
